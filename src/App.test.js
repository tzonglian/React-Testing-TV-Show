...
import { render, screen, wait, getByTestId } from "@testing-library/react";
import App from "./App";
...
describe("App tests", () => {
  ...
  test("fetches episode data and renders data", async () => {
    ...
    //Ensure data shows up on screen
    const summaryTest = await screen.findByText(/A love letter/i);
